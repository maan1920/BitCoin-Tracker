...
threshold = 30000 # If the price is below our threshold, out tracker will send us alert
time_interval = 5 * 60 # Periodic time after which our tracker send us alert
